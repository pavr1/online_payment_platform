...
type HttpHandler struct {
	...
	paymentAuthenticator IPaymentAuthenticator
}

func NewHttpHandler(log *log.Logger, config *config.Config, repoHandler repo.IRepoHandler, paymentAuthenticator IPaymentAuthenticator) *HttpHandler {
	return &HttpHandler{
		log:                  log,
		config:               config,
		repo:                 repoHandler,
...
func (h *HttpHandler) ProcessPurchase() func(w http.ResponseWriter, r *http.Request) {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		statusCode, body, err := h.paymentAuthenticator.IsValidToken(token)
		if err != nil {
